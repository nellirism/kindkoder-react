...
function Story() {
  return (
    <div class="container col-xxl-8 px-4 py-5 bg-white mt-3 ">
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5 justify-content-center ">
        ...
        <div class="col-lg-8 mt-2 ">
          <h1 class="display-5 fw-bold lh-1 mb-3 text-center ">My Story</h1>
      ...
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5 justify-content-center ">
        ...
        <div class="col-lg-8 mt-2 ">
          ...
          <p class="text-justify">
            As I have mentioned above, I graduated from a Computer Science
            degree ages ago. I learned coding from a friend who mentored me
            until the time he had me replace him on his job as a Systems
            Developer at a manufacturing company in the Philippines. I learned
            to code more however when i left the job and then had to leave the
            country, I did not continue on learning coding and did not pursue a
            coding job. A few years later, I realized that I wanted to come back
            to learning coding again.Hence the reason why I am doing the
            bootcamp.
          </p>
